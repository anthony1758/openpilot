...
DAYS_NO_CONNECTIVITY_MAX = 5000  # do not allow to engage after a week without internet
DAYS_NO_CONNECTIVITY_PROMPT = 4999  # send an offroad prompt after 4 days with no internet
